...
-- │ Icons                                                    │
-- ╰──────────────────────────────────────────────────────────╯
vim.api.nvim_set_hl(0, 'DapBreakpoint', { ctermbg = 0,  }) -- red, lightgrey bg
vim.api.nvim_set_hl(0, 'DapLogPoint', { ctermbg = 0, fg = '#61afef' }) -- blue
vim.api.nvim_set_hl(0, 'DapStopped', { ctermbg = 0, fg = '#993939', bg = '#d3d3d3' }) -- red, lightgrey bg
...
keymap("n", "<leader>d0", "<CMD>lua require('dap').step_out()<CR>", opts)
keymap("n", "<leader>dt", "<CMD>lua require('dap').terminate()<CR>", opts)
keymap("n", "<leader>dj", "<CMD>lua require('dap').up()<CR>", opts)
keymap("n", "<leader>dk", "<CMD>lua require('dap').down()<CR>", opts)
...
for i, ext in ipairs(exts) do
  dap.configurations[ext] = {
    ...
    },
    {
      ...
      cwd = vim.fn.getcwd(),
      runtimeArgs = { "--inspect-brk", "./node_modules/.bin/jest", "--runInBand", "--coverage", "false" },
      runtimeExecutable = "node",
